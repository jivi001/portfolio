        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <FadeIn delay={0.2}>
            <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
              Defending Networks with <span className="gradient-text">Intelligent Detection</span><br />
              & Threat Analysis
            </h1>
          </FadeIn>
          <FadeIn delay={0.3}>
            <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Specializing in ML-powered Intrusion Detection, Security Analytics, and Threat Intelligence — 
              building adaptive defense systems that detect zero-day attacks and evolving threats in real-time.
            </p>
          </FadeIn>
